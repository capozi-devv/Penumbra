...
public class WingsFeatureRenderer extends FeatureRenderer<PlayerEntity, PlayerEntityModel<PlayerEntity>> {
    private static final Identifier TEXTURE = new Identifier("penumbra", "textures/entity/eclipse_wings.png");
    private final EclipseWings<PlayerEntity> model;

    private final float offsetX;
    private final float offsetY;
    private final float offsetZ;

    public WingsFeatureRenderer(
        ...
        super(context);
        this.model = new EclipseWings<>(modelPart);
